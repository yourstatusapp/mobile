...
import { Fill, Icon, IconButton, Row, SmallButton, SmallInput, Spacer, Text, TextButton, WideButton } from '@parts';
			...
			<TouchableWithoutFeedback style={{ flex: 1 }} onPress={() => Keyboard.dismiss()}>
				<>
					...
					<SidePadding>
						...
						<SmallButton text="Show history" onPress={() => nav.navigate('StatusHistory')} />
