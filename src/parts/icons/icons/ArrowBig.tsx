import * as React from 'react';import { Path, Svg, G } from 'react-native-svg';interface IconArrowBigProps {color?: any;style?: any;size: number;}export const ArrowBig: React.FC<IconArrowBigProps> = (p) => {return (<Svg style={p.style} width={p.size} height={p.size} viewBox="0 0 26 23" fill={p.color}
